...
public class Part3 {
    ...
    public void testPrintAllGenes() {
        ...
        System.out.println("Practice quiz Q1");
    ...
    public void testCountGenes() {
        // This method calls countGenes with many example strings
        // and prints the result for each. 
        // You should create several examples with different numbers of genes
        // to test your code.
        System.out.println(countGenes("ATGTAAGATGCCCTAGT"));
        System.out.println("above should be 2");
        System.out.println(countGenes("ATGAATAATAGTGATGT1TTAAATGT2TTAAATGT3TTAA"));
        System.out.println("above should be 3");
        System.out.println(countGenes("ATGA1ATAAATGA2ATAAAATTAAATAA"));
        System.out.println("above should be 2");
        System.out.println(countGenes("ATGA1ATAATAGTGAATGA2ATAA"));
        System.out.println("above should be 2");
        System.out.println(countGenes("ATGAATAATAGTGAATGAATAA"));
